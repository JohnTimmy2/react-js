...
const STUDENTS_DATA = [
  { firstName: "An", lastName: "yo", batch: 1, age: 20 },
  { firstName: "Bình", lastName: "gurt", batch: 1, age: 22 },
  { firstName: "Cẩm", lastName: "uma", batch: 1, age: 21 },
  { firstName: "An", lastName: "placeholder", batch: 2, age: 19 }, // Duplicate first name !
];
...
updateStudentAge("An", "placeholder", 2, 30);
